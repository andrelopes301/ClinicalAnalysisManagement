    ...
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                var emailResult = await _userManager.SetEmailAsync(user, Input.NewEmail);

                

                if (!emailResult.Succeeded)
                {
                    StatusMessage = "Erro ao tentar atualizar o seu e-mail.";
                ...
                StatusMessage = "Email alterado com sucesso!";

                return RedirectToPage();
            }

            StatusMessage = "O seu E-mail continua a ser o mesmo!";
            return RedirectToPage();
        }
        /*
